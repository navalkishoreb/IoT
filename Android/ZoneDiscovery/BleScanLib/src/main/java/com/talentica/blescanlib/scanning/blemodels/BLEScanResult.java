 ...
 */
@TargetApi(Build.VERSION_CODES.LOLLIPOP) public final class BLEScanResult implements Parcelable {
  ...
  @Override public String toString() {
    ...
    stringBuilder.append("---------------")
        ...
        .append("\nDevice Address: ")
        .append(getDeviceAddress())
        .append("\nBond State: ")
        .append(getBondState().getDescription())
        .append("\nDevice Type: ")
        .append(getDeviceType().getType())
        .append("\nTx Power Level: ")
        .append(getTxPowerLevel())
        .append("\nRSSI :")
        .append(getRssi())
        .append("\n------------");
